...
+(NSString *)stringFromSeconds:(int)seconds{
   ...
   // return 0;
    ...
    return [NSString stringWithFormat:@"%@:%@",[self stringAddPreZero:min],[self stringAddPreZeroSecond:second]];
    //[self stringAddPreZero:hour]
}
...
+(NSString *)stringAddPreZeroSecond:(int)num{
    if(num<10&&num>=0){
