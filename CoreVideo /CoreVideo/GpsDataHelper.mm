...
+(NSDictionary *)readGpsData:(NSString *)filePath{
    ...
    }else if(m_node.is_DEV_NVT_66X==1){
        // count= m_assistInfo.ParseMOVSubtitle([chinesePath UTF8String]);
        count= m_assistInfo.ParseAssistDataForNovatek66x([chinesePath UTF8String]);
        
    }else if(m_node.is_DEV_A12){
        // count= m_assistInfo.ParseMOVSubtitle([chinesePath UTF8String]);
        //count= m_assistInfo.ParseAssistDataForNovatek([chinesePath UTF8String]);
        count= m_assistInfo.ParseMOVSubtitle(0,[chinesePath UTF8String]);
    }else  if(m_node.is_a7l){
        
        count= m_assistInfo.ParseMOVSubtitle(1,[chinesePath UTF8String]);
        //count= m_assistInfo.ParseAssistDataForNovatek([chinesePath UTF8String]);
    }else{
        count= m_assistInfo.ParseAssistDataForNovatek([chinesePath UTF8String]);
    }
