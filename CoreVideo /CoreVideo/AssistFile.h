...
private:
	...
	int ParseLine(char *pszLine, int key,int mode);
public:
	...
	int ParseAssistDataForSunplus(string strMOVFile);		//2013-03-04
		int ParseMOVSubtitle(int mode,string strMOVFile);				//2013-06-17  for A7s mov			//2013-06-17  for A7s mov
	int ParseAssistDataForNovatek(string strMOVFile);		//2013-08-19  for NTK mov
int ParseAssistDataForNovatek66x(string strMOVFile);  //2017-JAMES
